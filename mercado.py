...
SECCIONES = [
 ("Lácteos y proteína", ["Cottage alto en proteína", "Leche descremada",
   "Leche en polvo descremada", "Proteína en polvo", "Huevo entero", "Clara de huevo",
   "Tofu firme", "Tempeh", "Seitán", "Paneer", "Carne de soya seca (TVP)",
   "Parmesano", "Ricotta light", "Mozzarella light", "Crema light", "Leche de soya"]),
 ("Verdura", ["Espinaca", "Champiñones", "Brócoli", "Calabacín", "Tomate", "Zanahoria",
   "Habichuela", "Coliflor", "Pimentón", "Cebolla", "Cebolla larga", "Apio", "Pepino",
   "Papa", "Papa criolla", "Maíz tierno", "Limón", "Aguacate"]),
 ("Fruta", ["Banana", "Manzana", "Mango", "Naranja", "Plátano maduro", "Sandía"]),
 ("Congelados", ["Berries congelados", "Edamame congelado", "Espinaca congelada"]),
 ("Legumbres y granos", ["Lentejas rojas secas", "Lentejas cafés secas",
   "Lentejas negras secas", "Frijol rojo seco", "Frijoles negros secos",
   "Garbanzos de lata", "Lentejas de lata", "Frijoles refritos",
   "Arroz basmati crudo", "Arroz arborio crudo", "Arroz jazmín crudo",
   "Pasta cruda", "Avena en hojuelas", "Harina PAN", "Granola", "Pan integral"]),
 ("Despensa", ["Mantequilla de maní", "Almendras", "Marañones", "Aceite de oliva",
   ...
   "Dolmio", "Salsa mild", "Hummus", "Alcaparras", "Guascas", "Chocolate 85%",
