...
SECCIONES = [
 ("Lácteos y proteína", ["Cottage alto en proteína", "Leche descremada",
   ...
   "Tofu firme", "Tempeh", "Carne vegetal molida", "Queso cheddar light",
 ...
 ("Verdura", ["Espinaca", "Champiñones", "Brócoli", "Calabacín", "Tomate", "Zanahoria",
   ...
   "Papa", "Camote", "Maíz tierno", "Limón", "Aguacate"]),
 ...
 ("Legumbres y granos", ["Lentejas rojas secas", "Lentejas cafés secas",
   "Frijol rojo seco", "Frijoles negros secos", "Frijol rojo de lata",
   "Frijoles negros de lata", "Garbanzos de lata", "Lentejas de lata",
   "Arroz basmati crudo", "Arroz arborio crudo", "Arroz jazmín crudo",
   "Pasta cruda", "Avena en hojuelas", "Granola", "Pan integral", "Tostada integral",
   "Weet-Bix", "Harina PAN", "Arepa Sary con queso"]),
